...
//20.Leia uma temperatura a qual o usuário irá informar o Valor 
//e a escala atual: (Fahrenheit, Celsius, Kelvin) e informar a escala para qual deseja converter.
